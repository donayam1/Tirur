 ...
 * */
class pageswappergcmTestes(a:pageswappergcm) extends PeekPokeTester(a)
{
...
class psgcmTester extends ChiselFlatSpec
{
   behavior of "Page Swapper"
   backends foreach {backend =>
     it should s"should page our memory areas  $backend" in {
        Driver(() => new pageswappergcm, backend)(a => new pageswappergcmTestes(a)) should be (true)
     }     
   }
}
