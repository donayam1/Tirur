 ...
 * */
class pageswappergcmTestes3(a:pageswappergcm) extends PeekPokeTester(a)
{
...
class psgcmTester3 extends ChiselFlatSpec
{
   behavior of "Page Swapper"
   backends foreach {backend =>
     it should s"should page our memory areas  $backend" in {
        Driver(() => new pageswappergcm, backend)(a => new pageswappergcmTestes3(a)) should be (true)
     }     
   }
}
