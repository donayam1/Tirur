 ...
 * */
class ModuleTopPinVectorTestes(a:ModuleTop) extends PeekPokeTester(a)
{
...
class ModuleTopPinVectorTester extends ChiselFlatSpec
{
   behavior of "Page Swapper"
   backends foreach {backend =>
     it should s"should page our memory areas  $backend" in {
        Driver(() => new ModuleTop, backend)(a => new ModuleTopPinVectorTestes(a)) should be (true)
     }     
   }
}
