...
class uaenc_io extends Bundle{
  ...
  val rk0 = Output(UInt(128.W))
  val rk1 = Output(UInt(128.W))
  val rk2 = Output(UInt(128.W))
  val rk3 = Output(UInt(128.W))
  val rk4 = Output(UInt(128.W))
  val rk5 = Output(UInt(128.W))
  val rk6 = Output(UInt(128.W))
  val rk7 = Output(UInt(128.W))
  val rk8 = Output(UInt(128.W))
  val rk9 = Output(UInt(128.W))
  val rk10 = Output(UInt(128.W))
}

class unrolledaesenc extends Module{
  val io = IO(new uaenc_io)
...
object elaborateuaesenc extends App{
  chisel3.Driver.execute(args,()=> new unrolledaesenc)
}
